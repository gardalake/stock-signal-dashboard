...
GOOGLE_AI_STUDIO_URL, GOOGLE_AI_STUDIO_TOKEN, EMAIL_SMTP_PASSWORD = None, None, None
...
if st.session_state.get('ss_analysis_run_flag', False): # Usa .get per sicurezza
    ...
    with log_container:
        ...
        if asset_to_fetch_pipeline["type"] == "stock":
            ...
            cg_id_to_fetch = asset_to_fetch_pipeline.get("cg_id")
                        ...
                        if predictions_series is not None:
                            ...
                            if st.session_state.ss_data_ohlcv_display is not None and not st.session_state.ss_data_ohlcv_display.empty:
                                ...
                                if not common_idx_disp.empty:
                                    ...
                                    st.success(f"Segnali filtrati. Shape: {st.session_state.ss_final_signals_display.shape}")
